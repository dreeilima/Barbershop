  ...
  const handleBookingSubmit = async () => {
    ...
    try {
      ...
      toast("Reserva realizada com sucesso", {
        description: formatDate(newDate,"'Para' dd 'de' MMMM 'as' HH':'mm'.' ",{
          locale: ptBR,
        }),
        action: {
          label: "Visualizar",
              ...
              <Sheet open={sheetIsOpen} onOpenChange={setSheetIsOpen}>
                ...
                <SheetContent className="p-0">
                  ...
                  <Calendar
                    ...
                    {/* Mostrar a lista de horarios apenas se alguma data estiver selecionada */}
                  {date && (
                ...
                <div className="py-6 px-5 border-t border-solid border-secondary">
                  ...
                  <SheetFooter className="px-5">
                    <Button disabled={!date || !hour || submitIsLoading } onClick={handleBookingSubmit}>
                      {submitIsLoading && <Loader2 className="animate-spin mr-2 h-4 w-4"/>}
                      Confirmar reserva
                      </Button>
                  </SheetFooter>
