  ...
  return (
    <Sheet>
      ...
      <SheetContent className="px-0">
        <SheetHeader className="px-5 text-left border-b border-solid border-secondary pb-6">
          <SheetTitle>Informções da Reserva</SheetTitle>
        </SheetHeader>
            ...
            <AlertDialog>
              ...
              <AlertDialogContent className="w-[90%]">
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    Uma vez cancelada a reserva, não será possivel reverter está
                    ação.
                  </AlertDialogDescription>
                </AlertDialogHeader>
